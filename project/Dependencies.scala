...
object Dependencies {
  ...
  lazy val jacksonModule = "com.fasterxml.jackson.module" %% "jackson-module-scala" % "2.21.0"
  lazy val metadataSchema = "uk.gov.nationalarchives" %% "da-metadata-schema" % "0.0.114-SNAPSHOT"
