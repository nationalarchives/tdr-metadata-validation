...
object JsonSchemaDefinition {
  ...
  case object CLOSURE_SCHEMA_RETAINED extends JsonSchemaDefinition("/metadata-schema/closureSchemaRetained.schema.json", SCHEMA_CLOSURE_RETAINED)
